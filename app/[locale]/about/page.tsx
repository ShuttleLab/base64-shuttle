      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <section className="mb-16">
          <div className="bg-gradient-to-r from-primary via-primary to-chart-5 text-primary-foreground rounded-2xl p-8 sm:p-10 shadow-xl">
            ...
            <a href="https://base64.shuttlelab.org" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-white/15 hover:bg-white/25 transition-colors px-5 py-2.5 rounded-lg text-sm font-medium">
